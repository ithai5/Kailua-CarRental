...
public class ScannerReader {
    ...
    public static String scannerIntAsString() {
        ...
        String keystroke;
        for(keystroke = console.next(); keystroke.matches("^[a-zA-Z]*$"); keystroke = console.next()) {
    ...
    public static String scannerIntAsString(int size) {
        ...
        String keystroke;
        for(keystroke = console.next(); keystroke.matches("^[a-zA-Z]*$") || keystroke.length() != size; keystroke = console.next()) {
            System.out.println("This doesn't look right, try again only using numbers :)");
        }
